...
const uploadImage = multer({ limits: { fileSize: 20 * 1024 * 1024 }, /* 20MB Security Limit */ storage: imageStorage, fileFilter })
...
// PDF UPLOAD
// ============================================================================
const uploadPDF = multer({ limits: { fileSize: 20 * 1024 * 1024 }, /* 20MB Security Limit */ dest: 'tempPDF/' }).single('quotationPDF')
