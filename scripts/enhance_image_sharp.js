...
async function enhanceImage() {
    try {
        ...
        // 3. Sharpen the image aggressively to make it "crystal clear"
        await sharp(inputPath)
            ...
            .modulate({
                brightness: 1.05,
                saturation: 1.1 // Give it a slight pop to enhance perceived sharpness
            })
            .toFile(outputPath);

        console.log("Successfully sharpened and saved to", outputPath);
