...
async function migrate() {
    try {
        ...
        await pool.query(`ALTER TABLE order_pcbs ADD COLUMN status VARCHAR(50) DEFAULT 'pending' AFTER paymentSlip`);
    ...
    try {
        ...
        await pool.query(`ALTER TABLE order_pcbs ADD COLUMN updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP AFTER created_at`);
