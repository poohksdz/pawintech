          ...
          <Card className="shadow-sm">
            ...
            <Card.Body>
              ...
              <ListGroup variant="flush">
                ...
                <ListGroup.Item>
                  <strong>Company Name (Thai):</strong> {data.company_name_thai}
                </ListGroup.Item>
                <ListGroup.Item>
                  <strong>Head Office:</strong> {data.head_office}
                </ListGroup.Item>
                <ListGroup.Item>
                  <strong>Head Office (Thai):</strong> {data.head_office_thai}
                </ListGroup.Item>
                <ListGroup.Item>
                  <strong>Branch Name:</strong> {data.branch_name || "-"}
                </ListGroup.Item>
                <ListGroup.Item>
                ...
                <ListGroup.Item>
                  <strong>Is Head Office:</strong>{" "}
                  {data.is_head_office ? "Yes" : "No"}
                </ListGroup.Item>
                <ListGroup.Item>
                  <strong>Is Branch:</strong> {data.is_branch ? "Yes" : "No"}
                </ListGroup.Item>
                <ListGroup.Item>
                  <strong>Default Invoice:</strong>{" "}
                  {data.set_default ? "Yes" : "No"}
                </ListGroup.Item>
              </ListGroup>
            </Card.Body>
          </Card>
