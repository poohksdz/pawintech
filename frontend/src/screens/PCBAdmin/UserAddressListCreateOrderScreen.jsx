            ...
            <tbody>
              {filteredUsers.map((user, index) => (
                <tr key={user._id}>
                  ...
                  <td className="px-3 text-nowrap">{user.shippingAddress?.shippingname || '-'}</td>
                  <td className="px-3 text-nowrap">{user.shippingAddress?.address || '-'}</td>
                  <td className="px-3 text-nowrap">{user.shippingAddress?.city || '-'}</td>
                  <td className="px-3 text-nowrap">{user.shippingAddress?.country || '-'}</td>
                  <td className="px-3 text-nowrap">{user.shippingAddress?.postalCode || '-'}</td>
                  <td className="px-3 text-nowrap">{user.shippingAddress?.phone || '-'}</td>

                  <td className="px-3 text-nowrap">{user.billingAddress?.billingName || '-'}</td>
                  <td className="px-3 text-nowrap">{user.billingAddress?.billinggAddress || '-'}</td>
                  <td className="px-3 text-nowrap">{user.billingAddress?.billingCity || '-'}</td>
                  <td className="px-3 text-nowrap">{user.billingAddress?.billingCountry || '-'}</td>
                  <td className="px-3 text-nowrap">{user.billingAddress?.billingPostalCode || '-'}</td>
                  <td className="px-3 text-nowrap">{user.billingAddress?.billingPhone || '-'}</td>
                  <td className="px-3 text-nowrap">{user.billingAddress?.tax || '-'}</td>
