...
import { useUpdateDeliveryAssemblyPCBMutation } from '../../slices/assemblypcbApiSlice';
import { toast } from 'react-toastify';

const OrderassemblyDelieveryModle = ({ show, handleClose, orderId, onConfirm }) => {
 const [updateDeliveryAssemblyPCB] = useUpdateDeliveryAssemblyPCBMutation();
  ...
  const handleConfirm = async () => {
    ...
    try {
      await updateDeliveryAssemblyPCB({ pcborderId: orderId, transferedNumber }).unwrap();
...
export default OrderassemblyDelieveryModle