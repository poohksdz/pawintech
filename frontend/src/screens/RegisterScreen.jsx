...
const RegisterScreen = () => {
  ...
  const submitHandler = async (e) => {
    ...
    if (password !== confirmPassword) {
      const msg =
        language === "thai" ? "รหัสผ่านไม่ตรงกัน" : "Passwords do not match";
      toast.error(msg);
    ...
    try {
      ...
      navigate(redirect);
      toast.success(
        language === "thai" ? "ลงทะเบียนสำเร็จ" : "Registration Successful",
      );
    } catch (err) {
      // 3. จัดการ Error
      let errorMessage =
  ...
  // Input Style Helpers
  const inputClass =
    "block w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200";
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    value={city}
                    placeholder={language === "thai" ? "กรุงเทพฯ" : "City"}
                    className={inputClass}
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    value={country}
                    placeholder={language === "thai" ? "ไทย" : "Thailand"}
                    className={inputClass}
        ...
        <div className="sticky top-0 h-screen w-full overflow-hidden">
          ...
          <div className="relative z-10 w-full h-full flex flex-col justify-end p-16 text-white text-left">
            ...
            <p className="text-xl text-slate-300 max-w-md leading-relaxed font-medium">
              Get specialized electronics sourcing and PCB design services from
              the experts.
            </p>
