...
const OrderAssemblyDitalScreen = () => {
  ...
  const translations = {
    en: {
      ...
      subtitle:
        "We are building a comprehensive view for your Assembly Orders.",
    ...
    thai: {
      ...
      subtitle:
        "เรากำลังพัฒนาระบบแสดงรายละเอียดสำหรับงานประกอบ (Assembly) ของคุณ",
  ...
  return (
    ...
    >
      <Card
        className="border-0 shadow-sm rounded-4 text-center p-4 p-md-5"
      ...
      >
        <Card.Body>
          ...
          <p
            className="text-muted mb-5 small mx-auto"
