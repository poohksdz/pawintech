...
import { FaUserPlus, FaBuilding, FaUserTie, FaIdCard, FaMapMarkerAlt, FaSave, FaArrowLeft } from 'react-icons/fa';
                ...
                <Card.Body className="p-4">
                    <Form onSubmit={submitHandler}>
                        <Row className="g-3">
                            ...
                            <Col md={6}>
                                <Form.Group className="mb-3" controlId="customerName">
                                    <Form.Label className="fw-bold text-muted small"><FaBuilding className="me-1"/> {t.lbl.name} <span className="text-danger">*</span></Form.Label>
                                    <Form.Control
                                        type="text"
                        ...
                        <div className="d-grid">
                            <Button type="submit" variant="primary" size="lg" disabled={isLoading} className="shadow-sm">
