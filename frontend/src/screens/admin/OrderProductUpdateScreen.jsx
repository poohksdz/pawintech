        ...
        <Col md={8}>
          <ListGroup variant='flush'>
            <ListGroup.Item>
              ...
              <p>
                <strong>{t.nameLbl}: </strong> {order.shippingAddress.shippingname}
              </p>
              <p>
            ...
            <ListGroup.Item>
              ...
              <p>
                <strong>{t.nameLbl}: </strong> {order.billingAddress.billingName}
              </p>
              <p>
                <strong>{t.phoneLbl}: </strong> {order.billingAddress.billingPhone}
              </p>
              <p>
                <strong>{t.emailLbl}: </strong>{' '}
                <a href={`mailto:${order.user.email}`}>{order.user.email}</a>
              ...
              <p>
                <strong>{t.addressLbl}: </strong>
                {order.billingAddress.billinggAddress}, {order.billingAddress.billingCity}{' '}
              ...
              {order.isDelivered ? (
                <Message variant='success'>
                  {t.deliveredOnLbl} {format(new Date(order.deliveredAt), 'PPpp')}
                </Message>
              ) : (
          ...
          <Card>
            <ListGroup variant='flush'>
              ...
              <ListGroup.Item>
                <Row>
                  <Col >{t.itemsLbl}</Col>
                  <Col style={{textAlign: 'right', marginRight: '100px'}}>{order.itemsPrice} ฿</Col>
                </Row>
              </ListGroup.Item>
              <ListGroup.Item>
                <Row>
                  <Col >{t.vatLbl}</Col>
                  <Col style={{textAlign: 'right', marginRight: '100px'}}>{order.vatPrice} ฿</Col>
                </Row>
              </ListGroup.Item>
              <ListGroup.Item>
                <Row>
                  <Col>{t.shippingLbl}</Col>
                  <Col style={{textAlign: 'right', marginRight: '100px'}}>{order.shippingPrice} ฿</Col>
                </Row>
              </ListGroup.Item>
              <ListGroup.Item>
                <Row>
                  <Col>{t.totalLbl}</Col>
                  <Col style={{textAlign: 'right', marginRight: '100px'}}>{order.totalPrice} ฿</Col>
                </Row>
              </ListGroup.Item>
            </ListGroup>
          </Card>
            ...
            <ListGroup variant='flush'>
              ...
              <ListGroup.Item>
                <Row>
                  ...
                  <Col> {format(new Date(order.paymentResult.transferedDate), 'PPpp')}</Col>
                </Row>
              </ListGroup.Item>
              <ListGroup.Item>
                <Row>
                  <Row>
                    ...
                    <Col md={6} className="text-end">
                      <Image
                        ...
                        onClick={() => setZoomedImage(order.paymentResult.paymentSlip)}
                      />
                    </Col>
                </Row>
