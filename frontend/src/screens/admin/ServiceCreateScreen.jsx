  ...
  const t = {
    en: {
      ...
      lbl: {
        ...
        headerTh: "Header (Thai)",
        bodyTh: "Body Text (Thai)",
        img: "Upload Image",
    ...
    thai: {
      ...
      lbl: {
        headerEn: "หัวข้อ (ภาษาอังกฤษ)",
        bodyEn: "เนื้อหา (ภาษาอังกฤษ)",
        headerTh: "หัวข้อ (ภาษาไทย)",
        bodyTh: "เนื้อหา (ภาษาไทย)",
        img: "อัปโหลดรูปภาพ",
        type: "ประเภทบริการ",
      },
          ...
          <Card.Body>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                placeholder={t.ph.header}
                value={headerTh}
                onChange={(e) => setHeaderTh(e.target.value)}
              />
            </Form.Group>
            <Form.Group>
              <Form.Label className="small fw-bold text-muted">
            ...
            <Row className="align-items-center">
              ...
              <Col md={4} className="text-center">
                {image ? (
                  ...
                  <div className="bg-light rounded p-3 text-muted border border-dashed text-center small">
                    No Image Selected
                  </div>
                )}
              </Col>
  ...
  return (
    <Container fluid className="py-4 font-prompt">
      <Link
        ...
        className="btn btn-light mb-3 shadow-sm border"
      >
            ...
            <Card className="border border-primary border-opacity-25 bg-primary bg-opacity-10 mb-4 shadow-sm">
              <Card.Body>
                <Form.Group controlId="deploymentType">
                  ...
                  >
                    <option value="Hardware Deployment">
                      Hardware Deployment
                    </option>
                    <option value="Software Deployment">
                      Software Deployment
                    </option>
                  </Form.Select>
                </Form.Group>
