...
import { FaArrowLeft, FaSave, FaTags, FaLanguage, FaBarcode } from 'react-icons/fa';
...
const CategoryCreateScreen = () => {
  ...
  const submitHandler = async (e) => {
    e.preventDefault();
    // Basic validation
    if (!categoryName.trim() || !categoryNameThai.trim() || !categoryShortName.trim()) {
                ...
                <Card.Body className="p-4">
                    <Form onSubmit={submitHandler}>
                        ...
                        <div className="d-grid pt-2">
                            <Button type="submit" variant="primary" size="lg" className="text-white shadow-sm" disabled={isLoading}>
