      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-3xl py-20 text-center shadow-sm border border-slate-100">
            ...
            <Link
              to="/custompcb"
              className="mt-4 inline-block bg-blue-600 text-white px-6 py-2 rounded-full font-bold shadow-md hover:bg-blue-700 transition"
            >
              เริ่มสั่งทำ PCB เลย
            </Link>
          </div>
          ...
          <div className="space-y-6">
            {orders.map((order) => {
              ...
              return (
                <div
                  key={order._id}
                  className="bg-white rounded-[2rem] p-6 md:p-8 shadow-sm border border-slate-100 transition-all hover:shadow-md"
                >
                  {/* Order Info Header */}
