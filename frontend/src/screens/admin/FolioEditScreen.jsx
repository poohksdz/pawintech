...
const FolioEditScreen = () => {
  ...
  const {data: folio } = useGetFolioDetailsQuery(folioId); 
  const [updateFolio, { isLoading }] = useUpdateFolioMutation();
  const [uploadFolioImage ] = useUploadFolioImageMutation();

  const navigate = useNavigate();

  // ✅ แก้ไข: เพิ่ม || '' เพื่อป้องกัน Error กรณี Database ส่งค่า NULL มา
  useEffect(() => {
    if (folio) { 
      setHeaderTextOne(folio.headerTextOne || '');
      setHeaderTextTwo(folio.headerTextTwo || '');
      setHeaderTextThree(folio.headerTextThree || '');
      setHeaderTextFour(folio.headerTextFour || '');
      setHeaderTextFive(folio.headerTextFive || '');
  
      setBodyTextOne(folio.bodyTextOne || '');
      setBodyTextTwo(folio.bodyTextTwo || '');
      setBodyTextThree(folio.bodyTextThree || '');
      setBodyTextFour(folio.bodyTextFour || '');
      setBodyTextFive(folio.bodyTextFive || '');
  
      setHeaderThaiOne(folio.headerThaiOne || '');
      setHeaderThaiTwo(folio.headerThaiTwo || '');
      setHeaderThaiThree(folio.headerThaiThree || '');
      setHeaderThaiFour(folio.headerThaiFour || '');
      setHeaderThaiFive(folio.headerThaiFive || '');
  
      setBodyTextThaiOne(folio.bodyTextThaiOne || '');
      setBodyTextThaiTwo(folio.bodyTextThaiTwo || '');
      setBodyTextThaiThree(folio.bodyTextThaiThree || '');
      setBodyTextThaiFour(folio.bodyTextThaiFour || '');
      setBodyTextThaiFive(folio.bodyTextThaiFive || '');
  
      setImageOne(folio.imageOne || '');
      setImageTwo(folio.imageTwo || '');
      setImageThree(folio.imageThree || '');
      setImageFour(folio.imageFour || '');
      setImageFive(folio.imageFive || '');
  
      setVideoOneLink(folio.videoOneLink || '');
      setVideoTwoLink(folio.videoTwoLink || '');
      setVideoThreeLink(folio.videoThreeLink || '');
      setVideoFourLink(folio.videoFourLink || '');
      setVideoFiveLink(folio.videoFiveLink || '');
    }
  }, [folio]);
  ...
  const submitHandler = async (e) => {
    ...
    try {
      await updateFolio({
        folioId,
        headerTextOne, headerTextTwo, headerTextThree, headerTextFour, headerTextFive, bodyTextOne, bodyTextTwo, bodyTextThree, bodyTextFour, bodyTextFive, headerThaiOne, headerThaiTwo, headerThaiThree, headerThaiFour, headerThaiFive, bodyTextThaiOne, bodyTextThaiTwo, bodyTextThaiThree, bodyTextThaiFour, bodyTextThaiFive, imageOne, imageTwo, imageThree, imageFour, imageFive,  videoOneLink,  videoTwoLink,  videoThreeLink,  videoFourLink,  videoFiveLink
      }).unwrap(); 
...
<Form.Group controlId='headerTextOne' className='my-2'>
              ...
              <Form.Control
                ...
                value={headerTextOne}
                onChange={(e) => setHeaderTextOne(e.target.value)} 
              ></Form.Control>
            </Form.Group> 
            ...
            <Form.Group controlId='bodyTextOne'  className='my-2'>
              ...
              <Form.Control
                ...
                value={bodyTextOne}
                onChange={(e) => setBodyTextOne(e.target.value)} 
              ></Form.Control>
            </Form.Group> 
            ...
            <Form.Group controlId='headerThaiOne'  className='my-2'>
              ...
              <Form.Control
                ...
                value={headerThaiOne}
                onChange={(e) => setHeaderThaiOne(e.target.value)} 
              ></Form.Control>
            </Form.Group> 
            ...
            <Form.Group controlId='bodyTextThaiOne'  className='my-2'>
              ...
              <Form.Control
                ...
                onChange={(e) => setBodyTextThaiOne(e.target.value)} 
              ></Form.Control>
            </Form.Group> 
        ...
        {/* Form Fields for Tab 2 */} 
           <Form.Group controlId='headerTextTwo'  className='my-2'>
            ...
            <Form.Control
              ...
              value={headerTextTwo}
              onChange={(e) => setHeaderTextTwo(e.target.value)} 
            ></Form.Control>
          </Form.Group>
          ...
          <Form.Group controlId='bodyTextTwo'  className='my-2'>
            ...
            <Form.Control
              ...
              value={bodyTextTwo}
              onChange={(e) => setBodyTextTwo(e.target.value)} 
            ></Form.Control>
          </Form.Group>
...
<Form.Group controlId='headerThaiTwo'  className='my-2'>
  ...
  <Form.Control
    ...
    value={headerThaiTwo}
    onChange={(e) => setHeaderThaiTwo(e.target.value)} 
  ></Form.Control>
</Form.Group>
...
<Form.Group controlId='bodyTextThaiTwo'  className='my-2'>
  ...
  <Form.Control
    ...
    onChange={(e) => setBodyTextThaiTwo(e.target.value)} 
  ></Form.Control>
</Form.Group>
...
<Form.Group controlId='headerTextThree'  className='my-2'>
  ...
  <Form.Control
    ...
    onChange={(e) => setHeaderTextThree(e.target.value)} 
  ></Form.Control>
</Form.Group>
...
<Form.Group controlId='bodyTextThree'  className='my-2'>
  ...
  <Form.Control
    ...
    value={bodyTextThree}
    onChange={(e) => setBodyTextThree(e.target.value)} 
  ></Form.Control>
</Form.Group>
...
<Form.Group controlId='headerThaiThree'  className='my-2'>
  ...
  <Form.Control
    ...
    onChange={(e) => setHeaderThaiThree(e.target.value)} 
  ></Form.Control>
</Form.Group>
...
<Form.Group controlId='bodyTextThaiThree'  className='my-2'>
  ...
  <Form.Control
    ...
    onChange={(e) => setBodyTextThaiThree(e.target.value)} 
  ></Form.Control>
</Form.Group>
...
<Form.Group controlId='headerTextFour'  className='my-2'>
  ...
  <Form.Control
    ...
    onChange={(e) => setHeaderTextFour(e.target.value)} 
  ></Form.Control>
</Form.Group>
...
<Form.Group controlId='bodyTextFour'  className='my-2'>
  ...
  <Form.Control
    ...
    value={bodyTextFour}
    onChange={(e) => setBodyTextFour(e.target.value)} 
  ></Form.Control>
</Form.Group>
...
<Form.Group controlId='headerThaiFour'  className='my-2'>
  ...
  <Form.Control
    ...
    onChange={(e) => setHeaderThaiFour(e.target.value)} 
  ></Form.Control>
</Form.Group>
...
<Form.Group controlId='bodyTextThaiFour'  className='my-2'>
  ...
  <Form.Control 
    ...
    onChange={(e) => setBodyTextThaiFour(e.target.value)} 
  ></Form.Control>
</Form.Group>
...
<Form.Group controlId='headerTextFive'  className='my-2'>
  ...
  <Form.Control
    ...
    onChange={(e) => setHeaderTextFive(e.target.value)} 
  ></Form.Control>
</Form.Group>
...
<Form.Group controlId='bodyTextFive'  className='my-2'>
  ...
  <Form.Control
    ...
    value={bodyTextFive}
    onChange={(e) => setBodyTextFive(e.target.value)} 
  ></Form.Control>
</Form.Group>
...
<Form.Group controlId='headerThaiFive'  className='my-2'>
  ...
  <Form.Control
    ...
    onChange={(e) => setHeaderThaiFive(e.target.value)} 
  ></Form.Control>
</Form.Group>
...
<Form.Group controlId='bodyTextThaiFive'  className='my-2'>
  ...
  <Form.Control
    ...
    onChange={(e) => setBodyTextThaiFive(e.target.value)} 
  ></Form.Control>
</Form.Group>
...
export default FolioEditScreen;