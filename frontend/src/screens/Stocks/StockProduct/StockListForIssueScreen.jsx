...
} from "../../../slices/stockIssueApiSlice";
...
const StockListForIssueScreen = () => {
  ...
  const stockissuecartItems = useMemo(
    () => stockIssueCartState.stockissuecartItems || [],
    [stockIssueCartState],
  );
  ...
  const issueNowHandler = async () => {
    try {
      ...
      if (itemsToIssue.length === 0) {
        toast.error("Please select items to issue.", {
  ...
  const confirmRemove = () => {
    if (itemToRemove) dispatch(removeStockFromIssueCart(itemToRemove));
      ...
      <div className="w-full max-w-[1200px] flex flex-col lg:flex-row gap-0 border border-gray-200/60 shadow-sm rounded-md overflow-hidden bg-white">
          ...
          <div className="hidden md:grid grid-cols-12 pb-3 mb-6 border-b border-gray-100 text-[11px] uppercase tracking-[0.2em] text-gray-400 font-bold items-center">
            <div className="col-span-8 flex items-center gap-3">
              <input
                type="checkbox"
                checked={
                  selectedItems.length === stockissuecartItems.length &&
            ...
            <AnimatePresence>
              {stockissuecartItems.length === 0 ? (
                ...
                >
                  ...
                  <h3 className="text-[14px] font-bold text-gray-800 mb-2 uppercase tracking-wide">
                    Your issue cart is empty
                  </h3>
                  <Link
                    to="/componentrequestlist"
                    className="text-gray-500 hover:text-black mt-4 tracking-wide uppercase font-bold text-[12px] flex items-center gap-2 transition-colors"
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 items-start md:items-center">
                      ...
                      <div className="col-span-1 md:col-span-8 flex gap-4 items-start md:items-center w-full">
                        ...
                        <div className="flex flex-col pt-1 text-start w-full overflow-hidden">
                          ...
                          <span className="text-[12px] text-gray-500 font-medium leading-relaxed mb-3 line-clamp-1 truncate">
                          ...
                          <div className="w-full max-w-sm mt-auto relative">
                            <input
                              ...
                              onChange={(e) =>
                                updateIssueNote(p, e.target.value)
                              }
                            />
                      ...
                      <div className="col-span-1 md:col-span-4 flex md:justify-center items-center mt-2 md:mt-0 ml-8 md:ml-0">
                        <div className="flex w-[120px] h-[40px] border border-gray-300 rounded-sm overflow-hidden bg-white shadow-sm">
                          <button
                            onClick={() =>
                              updateIssueQty(p, Number(issueqty[p.ID]) - 1)
                            }
        ...
        <div className="w-full lg:w-[350px] bg-[#f8f8f8] p-4 md:p-6 lg:p-8 shrink-0 flex flex-col text-start border-t lg:border-t-0 lg:border-l border-gray-200/50">
          ...
          <button
            ...
            className={`w-full py-4 mb-8 rounded-md text-[13px] font-bold tracking-widest uppercase transition-all shadow-md flex items-center justify-center gap-3 ${
              selectedItems.length > 0
                ? "bg-[#222] text-white hover:bg-black border border-black"
          ...
          <div className="flex flex-col flex-grow">
            <div className="flex justify-between items-center mb-4 text-[13px] border-b border-gray-200/60 pb-4">
              ...
              <span className="text-gray-900 font-bold bg-white border border-gray-200 shadow-sm px-2.5 py-0.5 rounded-sm">
            ...
            <div className="flex justify-between items-center mb-10 text-[13px]">
              ...
              <span className="text-gray-900 font-black text-[24px] tracking-tighter">
            ...
            <div className="mt-auto">
              <div className="bg-white border border-dashed border-gray-300 rounded-sm p-4 md:p-6 shadow-sm">
                <p className="text-[11px] text-gray-500 font-medium leading-relaxed mb-4">
                  ...
                  Once confirmed, stock quantities will be permanently deducted
                  based on the values provided above.
                </p>
            ...
            {showIssueConfirm && (
              <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4">
                ...
                >
                  ...
                  <h3 className="text-[18px] font-bold text-gray-900 mb-2 uppercase tracking-tight">
                    Confirm Issuance
                  </h3>
                  <p className="text-[14px] text-gray-500 mb-8 font-medium">
                    You are about to perfectly issue{" "}
                    <strong className="text-black bg-gray-100 px-1 rounded">
                      {selectedItems.length}
                    </strong>{" "}
                    selected component(s) from inventory.
                  </p>
                  <div className="flex gap-4">
                    <button
                      onClick={() => setShowIssueConfirm(false)}
                      className="flex-1 py-3.5 border border-gray-300 bg-white text-gray-800 font-bold text-[13px] uppercase tracking-widest hover:bg-gray-50 transition-colors rounded-sm shadow-sm"
                    >
                      Cancel
                    </button>
                    <button
                      ...
                      className="flex-1 py-3.5 border border-black bg-[#222] text-white font-bold text-[13px] uppercase tracking-widest hover:bg-black transition-colors shadow-sm rounded-sm"
                    >
                      Confirm
                    </button>
                  </div>
            ...
            {showConfirmModal && (
              <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4">
                ...
                >
                  ...
                  <p className="text-[14px] text-gray-500 mb-8 font-medium">
                    Are you sure you want to remove this item from the issue
                    list?
                  </p>
                  <div className="flex gap-4">
                    <button
                    ...
                    <button
                      ...
                      className="flex-1 py-3.5 border border-red-600 bg-red-600 text-white font-bold text-[13px] uppercase tracking-widest hover:bg-red-700 hover:border-red-700 transition-colors shadow-sm rounded-sm"
                    >
                      Remove
                    </button>
                  </div>
