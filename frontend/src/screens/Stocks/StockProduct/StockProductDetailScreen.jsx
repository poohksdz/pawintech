...
import {
  ...
  OverlayTrigger,
  Tooltip,
} from "react-bootstrap"; // ลบ Badge ออกจากบรรทัดนี้แล้ว
import {
  FaArrowLeft,
  FaBox,
  FaRegCopy,
...
const StockProductDetailScreen = () => {
  ...
  if (isError)
    return <Message variant="danger">Error loading product details</Message>;
  ...
  const DetailRow = ({
    ...
    <div className="detail-row-item">
      ...
      <div
        className={`detail-value-group ${highlight ? "fw-bold text-dark" : ""}`}
      >
        {isLink && value ? (
          <a
            href={value}
      ...
      <Card className="hero-card border-0 mb-4 shadow-sm">
        <Card.Body className="p-0">
          <Row className="g-0">
            <Col
              md={3}
              className="hero-image-section border-end bg-white d-flex align-items-center justify-content-center p-4"
            >
            ...
            <Col md={9} className="hero-info-section p-4 bg-white">
              <div className="d-flex justify-content-between align-items-start">
                <div className="flex-grow-1">
                  <div className="badge-group mb-2">
                    <span className="badge-pill bg-primary bg-opacity-10 text-primary small px-2 py-1 rounded me-2 fw-bold">
                      {product.category}
                    </span>
                    <span className="text-muted small">/</span>
                    <span className="badge-pill bg-light text-secondary small px-2 py-1 rounded ms-2 fw-bold">
                      {product.subcategory}
                    </span>
                  </div>

                  <h1
                    className="hero-mpn fw-bold mb-3 mt-2"
                  ...
                  <div className="hero-value d-flex align-items-center">
                    <span className="text-muted fw-bold small me-2">
                      VALUE:
                    </span>
                ...
                <div
                  className="qty-block bg-light p-3 rounded-4 text-center"
                ...
                >
                  ...
                  <div
                    className={`h2 mb-0 fw-bold ${product.quantity > 0 ? "text-success" : "text-danger"}`}
                  >
              ...
              <div className="hero-description mt-4 pt-3 border-top">
                ...
                <p className="text-secondary mb-0">
                  <CopyItem text={product.description && product.description !== "No description available." ? product.description : product.value} label="Description" />
                </p>
              </div>
            </Col>
          </Row>
        ...
        <Col lg={4}>
          <Card className="info-card h-100 border-0 shadow-sm rounded-4">
            <Card.Header className="bg-white border-0 pt-4 px-4 pb-0">
              <div className="d-flex align-items-center">
                <div className="bg-info bg-opacity-10 text-info p-2 rounded-3 me-3">
                  <FaLayerGroup />
                </div>
            ...
            <Card.Body className="p-4">
              ...
              <DetailRow
                icon={<FaTag />}
                label="Electotronix P/N"
                value={product.electotronixPN && product.electotronixPN !== "-" ? product.electotronixPN : (product.barcode || "-")}
                highlight={true}
              />
            </Card.Body>
          </Card>
          ...
          <Card className="info-card h-100 border-0 shadow-sm rounded-4">
            ...
            <Card.Body className="p-4">
              ...
              <div className="mt-4 p-3 rounded-4 bg-warning bg-opacity-10 border-start border-4 border-warning">
                <span className="d-block small fw-bold text-warning mb-1">
                  <FaClipboardList className="me-1" /> NOTE
                </span>
