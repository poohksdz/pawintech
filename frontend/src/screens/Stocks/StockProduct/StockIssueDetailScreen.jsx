  ...
  return (
    <Container fluid className="py-4 bg-light min-vh-100 font-sans">
      ...
      <div className="mb-4">
        <Button
          variant="link"
          className="text-decoration-none text-dark p-0 fw-bold d-flex align-items-center"
          onClick={() => navigate("/componentissuelist")}
        >
          <div
            className="bg-white border rounded-circle d-flex align-items-center justify-content-center me-2 shadow-sm"
            ...
            <Card.Body className="p-4">
              ...
              <div className="d-flex flex-column flex-md-row justify-content-between align-items-start mb-4">
                <div style={{ flex: 1 }}>
                  ...
                  <Badge
                    bg="primary"
                    className="mb-2 bg-opacity-10 text-primary border border-primary border-opacity-25 fw-bold px-3 py-2"
                  >
                  ...
                  <div className="d-flex align-items-center gap-2 mb-1">
                    <h2 className="fw-bold text-dark mb-0">
                      {product.electotronixPN || product.manufacturePN}
                    </h2>
              ...
              <div className="mb-5">
                <div className="d-flex align-items-center justify-content-between mb-3">
                  ...
                  {product.description && (
                    <OverlayTrigger
                      overlay={<Tooltip>Copy Description</Tooltip>}
                    >
                      <Button
                        variant="link"
                        ...
                        onClick={(e) =>
                          handleCopy(e, product.description, "Description")
                        }
                      >
                ...
                <Col md={6}>
                  <Card className="h-100 border bg-white shadow-none">
                    ...
                    <Card.Body className="p-3">
                      ...
                      <DetailRow
                        label="Mfg Part No."
                        value={product.manufacturePN}
                      />
                      <DetailRow label="Supplier" value={product.supplier} />
                      <DetailRow
                        label="Supplier P/N"
                        value={product.supplierPN}
                      />
                      <DetailRow
                        label="Request No."
