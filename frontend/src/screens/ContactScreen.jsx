...
const ContactScreen = () => {
  ...
  const translations = {
    en: {
      ...
      address: "139/65 Soi Romklao 24, Romklao Road, Min Buri Subdistrict, Min Buri District, Bangkok 10510.",
      mapCaption: "Location Map",
    },
    thai: {
      title: "ติดต่อเรา",
      companyName: "บริษัท ภาวินท์เทคโนโลยี จำกัด",
      address: "139/65 ซอยร่มเกล้า24 ถนนร่มเกล้า แขวงมีนบุรี เขตมีนบุรี กรุงเทพ 10510",
            ...
            <Card className="h-100 border-0 shadow-sm rounded-4 overflow-hidden">
              <Card.Body className="p-3 p-md-4 p-lg-5">
                ...
                <div className="d-flex mb-4">
                  <IconWrapper color="#dc3545"><FaMapMarkerAlt /></IconWrapper>
                  <div className="ms-3">
                ...
                {/* Phone */}
                <div className="d-flex mb-4">
                  <IconWrapper color="#198754"><FaPhoneAlt /></IconWrapper>
                  <div className="ms-3 d-flex align-items-center">
                    <a href="tel:0992263277" style={linkStyle} className="hover-primary">
                      099-226-3277
                    </a>
                  </div>
                </div>
                ...
                {/* Line */}
                <div className="d-flex mb-4">
                  <IconWrapper color="#06c755"><FaLine /></IconWrapper>
                  <div className="ms-3 d-flex align-items-center">
                    <a href="https://line.me/ti/p/pwtech" target="_blank" rel="noopener noreferrer" style={linkStyle}>
                      @pwtech
                    </a>
                  </div>
                </div>
                ...
                {/* Email */}
                <div className="d-flex mb-4">
                  <IconWrapper color="#ffc107"><MdEmail /></IconWrapper>
                  <div className="ms-3 d-flex align-items-center">
                ...
                <div className="d-flex">
                  <IconWrapper color="#1877f2"><FaFacebook /></IconWrapper>
                  <div className="ms-3 d-flex align-items-center">
                    <a href="https://www.facebook.com/@electotronixth" target="_blank" rel="noopener noreferrer" style={linkStyle}>
                      electotronixth
                    </a>
                  </div>
                </div>
              ...
              <div style={{ height: '100%', minHeight: '400px', position: 'relative' }}>
                ...
                >
                  <p className="text-white mb-0 fw-light text-center">
                    <FaMapMarkerAlt className="me-2" />{t.mapCaption}
                  </p>
                </div>
              </div>
            </Card>
