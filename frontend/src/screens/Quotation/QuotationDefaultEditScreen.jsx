...
const QuotationDefaultEditScreen = () => {
  ...
  const { data, isLoading: loadingData } = useGetDefaultQuotationDetailsQuery(id)
  const [updateDefaultQuotation, { isLoading: updating }] = useUpdateDefaultQuotationMutation()
  ...
  const handleSubmit = async (e) => {
    ...
    const buyerUrl = buyerApproves ? await handleUploadImage(buyerApproves, 'buyer') : buyerApprovesPreview
    const salesPersonUrl = salesPerson ? await handleUploadImage(salesPerson, 'salesPerson') : salesPersonPreview
    const salesManagerUrl = salesManager ? await handleUploadImage(salesManager, 'salesManager') : salesManagerPreview
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex items-center gap-4">
            <h2 className="text-2xl font-black text-slate-800 tracking-tight">Edit Default Quotation</h2>
            {updating && <Loader />}
          </div>
        </div>
