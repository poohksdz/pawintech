          ...
          <Col md={9}>
            <Card>
              ...
              <ListGroup variant="flush">
                <ListGroup.Item>
                  <strong>Company Name (EN):</strong> {q.company_name}
                </ListGroup.Item>
                <ListGroup.Item>
                  <strong>Company Name (TH):</strong> {q.company_name_thai}
                </ListGroup.Item>
                <ListGroup.Item>
                  <strong>Head Office (EN):</strong> {q.head_office}
                </ListGroup.Item>
                <ListGroup.Item>
                  <strong>Head Office (TH):</strong> {q.head_office_thai}
                </ListGroup.Item>
                <ListGroup.Item>
                  <strong>Tel:</strong> {q.tel}
                </ListGroup.Item>
                <ListGroup.Item>
                  <strong>Email:</strong> {q.email}
                </ListGroup.Item>
                <ListGroup.Item>
                  <strong>Tax ID:</strong> {q.tax_id}
                </ListGroup.Item>
                <ListGroup.Item>
                  <strong>Discount:</strong> {q.discount}%
                </ListGroup.Item>
                <ListGroup.Item>
                  <strong>VAT:</strong> {q.vat}%
                </ListGroup.Item>
                <ListGroup.Item>
                  <strong>Branch:</strong> {q.branch_name}
                </ListGroup.Item>
                <ListGroup.Item>
                ...
                <ListGroup.Item>
                  <strong>Deposit:</strong> {q.deposit ? `${q.deposit} %` : "-"}
                </ListGroup.Item>
              </ListGroup>
            </Card>
          </Col>
