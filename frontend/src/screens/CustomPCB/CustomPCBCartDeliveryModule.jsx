...
import { useUpdateDeliveryCustomPCBMutation } from '../../slices/custompcbApiSlice';
import { toast } from 'react-toastify';

const CustomPCBCartDeliveryModule = ({ show, handleClose, orderId, onConfirm }) => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      await updateDeliveryCustomPCB({ pcborderId: orderId, transferedNumber }).unwrap();
...
export default CoustomPCBCartDeliveryModle