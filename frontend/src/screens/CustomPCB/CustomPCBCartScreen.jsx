...
const CustomPCBCartScreen = () => {
  ...
  const myCartItems = useMemo(
    () =>
      cartItems?.data
        ?.filter(
          (item) => item.user_id?.toString() === userInfo?._id?.toString(),
        )
  ...
  const selectedItems = myCartItems.filter((item) =>
  ...
  const checkoutHandler = () => {
    ...
    const firstAcceptedItem = selectedItems.find(
        ...
        <div className="flex-1 p-0 md:p-6 bg-white text-start">
          ...
          <div className="md:hidden flex items-center justify-between px-4 py-4 mb-2 bg-slate-50/50 rounded-2xl border border-slate-100">
            ...
            <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
              {myCartItems.length} {language === "thai" ? "รายการ" : "Items"}
            </span>
          </div>
            ...
            <div className="mt-4">
              ...
              <div className="bg-gray-50 border border-dashed border-gray-200 rounded p-4 mb-6">
                <p className="text-[10px] text-gray-400 font-bold uppercase leading-relaxed tracking-wide text-center">
                  Custom PCB orders are manually reviewed.
                  <br />
                  Status updates to "Approved" once verified.
                </p>
              </div>
            ...
            >
              ...
              >
                ...
                <p className="text-[14px] text-gray-600 mb-8 font-medium">
                  This action will permanently remove the project data from our
                  system.
                </p>
