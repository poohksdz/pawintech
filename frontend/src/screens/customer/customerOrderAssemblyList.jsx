...
const CustomerOrderAssemblyList = () => {
  ...
  const translations = {
    en: {
      ...
      subtitle: 'We are working hard to bring you the Assembly Order feature soon.',
      goBack: 'Back to Dashboard',
      stayTuned: 'Stay tuned for updates!'
    },
    thai: {
      title: 'ฟีเจอร์นี้กำลังอยู่ในระหว่างการพัฒนา',
      subtitle: 'เรากำลังเร่งดำเนินการเพื่อเปิดให้ใช้งานระบบสั่งประกอบ (Assembly) เร็วๆ นี้',
  ...
  return (
    <Container className="d-flex justify-content-center align-items-center" style={{ minHeight: '70vh' }}>
      <Card className="border-0 shadow-sm rounded-4 text-center p-5" style={{ maxWidth: '600px', width: '100%' }}>
        <Card.Body>
