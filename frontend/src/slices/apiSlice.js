...
export const apiSlice = createApi({
  ...
  tagTypes: [
    'Product', 'Order', 'User', 'Service', 'Showcase',
    'Category', 'OrderPCB', 'CustomPCB', 'CustomPCBCart',
    'CopyPCB', 'CopyPCBCart', 'Blog', 'Email', 'StockProduct',
    'Aboutimage', 'Aboutimages', 'Notification',
  ],
  endpoints: (builder) => ({}),
